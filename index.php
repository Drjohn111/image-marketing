...
if($row>0)
{
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,designation) values('$fname','$lname','$email','$enc_password','$contact','$designation')");
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								<p>First Name </p>
								<input type="text" class="text" value="First Name"  name="fname" required >
								<p>Last Name </p>
								<input type="text" class="text" value="Last Name" name="lname"  required >
								<p>Email Address </p>
								<input type="text" class="text" value="E-mail" name="email"  >
								<p>Password </p>
								<input type="password" value="" name="password" required>
										<p>Contact No. </p>
								<input type="text" value="Contact" name="contact"  required>
								<p>Designation</p>
								<input type="text" class="text" value="" name="designation" required>
